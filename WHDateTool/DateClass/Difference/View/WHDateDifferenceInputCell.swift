...
//  DateCalculator
//
//  Created by Chen Kang on 5/6/18.
//  Copyright © 2019 Chen Kang. All rights reserved.
//

import UIKit

class WHDateDifferenceInputCell: UITableViewCell {
    ...
    weak var delegate: WHDateDifferenceInputCellDelegate?
...
extension WHDateDifferenceInputCell: UITextFieldDelegate {
