...
//  BaseConverter
//
//  Created by Chen Kang on 4/23/18.
...
class WHHomeViewController: UIViewController {
    
    weak var delegate: WHHomeViewControllerDelegate?
...
//        bannerView = createAndLoadBannerView()
    ...
    @objc func closedButtonAction() {
        delegate?.WHloadThemeAndUpdateFormat(isLightTheme: isLightTheme)
...
extension WHHomeViewController: HomeViewDelegate {
...
extension WHHomeViewController:  MFMailComposeViewControllerDelegate {
...
//extension WHHomeViewController: GADBannerViewDelegate {
//
